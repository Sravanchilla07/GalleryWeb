        ...
        <div class="row">
            <div align="center">
                <button onClick={()=>dispatch(getAllImages())}
                 class="btn btn-primary filter-button" data-filter="all">
                  All
                 </button>
            ...
            return (
            <div class="gallery_product col-lg-4 col-md-sm-4 col-xs-6 filter hdpe my-4">
                <img src={`http://localhost:8000/${item.name}` }alt=""
